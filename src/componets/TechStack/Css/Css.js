  ...
  render() {
    ...
    <Fragment>
        <svg className="tech-icon" viewBox="0 0 128 128">
            ...
            <path fill="#4b4b4b" d="M89 14.374l-7.149-8.374h7.149v-5h-16v4.363l8.39 7.637h-8.39v5h16zM70 14.374l-6.807-8.374h6.807v-5h-15v4.363l7.733 7.637h-7.733v5h15zM52 13h-8v-7h8v-5h-14v17h14z"></path>
        </svg>
    </Fragment>
    )}
}
