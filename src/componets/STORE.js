    ...
    Projects : [
        {
            ...
            img:"/images/Penny-Thoughts2.png"
        },
        {
            id: 2,
            name: 'Space Rep',
            live:'https://spaced-rep-french.vercel.app',
            summary: "This app was created to help anyone trying to learn French. It has implemented the spaced repetition technique to help its users quickly learn ten preloaded French words. New users can create an account, whereas returning users can log in and begin practicing with instant feedback and reinforcement.",
            repo: "https://github.com/thinkful-ei-narwhal/french-langue-cesarkevin",
            tech: ["html","css","js","node","postgresql","react","knex", "mocha","express"],
            img:"/images/Spaced-Rep2.png"
        },
        {
            id: 3,
